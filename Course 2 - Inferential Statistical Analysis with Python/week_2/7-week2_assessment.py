...
sd_nap = np.std(bedtime_nap)
nap_se_mean_bedtime = sd_nap / np.sqrt(n_nap)
nap_se_mean_bedtime
...
sd_no_nap = np.std(bedtime_no_nap)
no_nap_se_mean_bedtime = sd_no_nap / np.sqrt(n_no_nap)
...
no_nap_t_star = t.ppf(0.95, n_no_nap-1)
no_nap_t_star
...
print("Mean: {}".format(no_nap_mean_bedtime))
lcb = no_nap_mean_bedtime - no_nap_t_star*no_nap_se_mean_bedtime
ucb = no_nap_mean_bedtime + no_nap_t_star*no_nap_se_mean_bedtime
print("Confidence Int:")
(lcb, ucb)
